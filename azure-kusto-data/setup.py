...
setup(
    ...
    install_requires=["python-dateutil>=2.8.0", "requests>=2.13.0", "azure-identity>=1.5,<1.20", "msal~=1.9.0"],
    extras_require={"pandas": ["pandas"], "aio": ["aiohttp>=3.4.4,<3.12.0", "asgiref~=3.2.3"]},
)
